# DevOps Crypto Architect Bibliography
...
- **Prysm (Consensus)**: https://docs.prylabs.network/docs/getting-started
- **Lighthouse (Consensus)**: https://lighthouse-book.sigmaprime.io/
...
- **Smart Contracts Registry**: https://github.com/0xHoneyJar/thj-meta-knowledge/blob/main/contracts/REGISTRY.md
