...
| Artifact | Path | Focus |
|----------|------|-------|
| Drift Report | `loa-grimoire/drift-report.md` | Ghost Features, Shadow Systems |
| Governance Report | `loa-grimoire/governance-report.md` | Process maturity, compliance |
| Consistency Report | `loa-grimoire/consistency-report.md` | Code patterns, velocity |
| Hygiene Report | `loa-grimoire/reality/hygiene-report.md` | Technical debt, decisions |
| Trajectory Audit | `loa-grimoire/trajectory-audit.md` | Analysis confidence |
