...
## Sigil Learning Review

In addition to Loa skills, `/skill-audit` can review Sigil physics learnings.

### Usage

```
/skill-audit --sigil       # Review pending physics learnings
```
...
3. Promote approved learnings to appropriate location
...
│  {target from entry}                                   │
│                                                        │
│  [a] Approve and promote                               │
│  [r] Reject and archive                                │
...
| Target | Destination |
|--------|-------------|
| taste.md pattern | `grimoires/sigil/taste.md` |
| Rule update | `.claude/rules/{specified file}` |
| constitution.yaml | `grimoires/sigil/constitution.yaml` |
| Anti-pattern | `.claude/rules/00-sigil-core.md:anti_patterns` |
...
Rejected learnings: `grimoires/sigil/context/archive/rejected-learnings.md`
